...
public class LoginSteps {
    ...
    public void queEstejaNaPaginaDeLoginEInformoOsSeguintesDadosParaIniciarOCadastro(Map<String, String> map) {
        queEstejaNaPaginaPrincipalDeMyStore();
        acessoAPaginaDeLogin();
        loginPage = new LoginPage();
        loginPage.iniciarSignUp(map.get("nome"), map.get("email"));
    }
}
